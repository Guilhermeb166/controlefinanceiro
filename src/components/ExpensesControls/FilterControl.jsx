/**
 * Componente de formulário para seleção de filtros de transações com tema escuro
 */
"use client"
...
export default function FilterControl({ filters, setFilters, onApplyFilters, creditCards }) {
    ...
    return (
        <div className='flex flex-col gap-4'>
            <p className="text-xl text-start tracking-[0.5px] text-white font-semibold">Filtros</p>
            <div className='flex flex-wrap gap-3'>
                    ...
                    <FormControl size="small" fullWidth sx={muiStyles}>
                        ...
                        >
                            ...
                            {Array.from({ length: 12 }, (_, i) => (
                                ...
                                <MenuItem   MenuItem key={i} value={i + 1}>
                ...
                <button
                    ...
                    className="cursor-pointer mt-2 px-4 py-2 rounded bg-emerald-600 text-white hover:bg-emerald-700 w-full transition-colors font-medium"
                >
                    Aplicar filtros
                </button>
            </div>
